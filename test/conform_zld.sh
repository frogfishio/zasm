...
rg -q "conformance: missing loc.line" "$build_dir/missing_loc.err"
...
rg -q "conformance: empty operand string" "$build_dir/empty_sym.err"
...
rg -q "conformance: invalid label" "$build_dir/bad_ident.err"
