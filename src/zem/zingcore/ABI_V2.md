...
- In native/JIT: offsets into a contiguous guest memory region provided by the runtime.
...
## 5. Capability discovery/open (typed, not framed)
...
## 6. File system capability (`kind="file", name="fs"`)
...
## 7. Async capability (`kind="async", name="default"`)
...
## 8. Time capability (`kind="time", name="default"`)
...
## 10. Conformance expectations (fast runner)
