...
static int cap_net_tcp_describe(uint8_t* out, size_t cap,
...
static const zi_cap_v1 cap_net_tcp_v1 = {
  .kind = "net",
  .name = "tcp",
  .version = 1,
  .cap_flags = 0,
  .meta = NULL,
  .meta_len = 0,
  .describe = cap_net_tcp_describe,
  .open = NULL,
};

__attribute__((constructor))
static void cap_net_tcp_register(void) {
  zi_cap_register(&cap_net_tcp_v1);
}
