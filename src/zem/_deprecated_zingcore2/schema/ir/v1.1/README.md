...
Version: **v1.1** (current stable contract).
...
- Memory operands use `{ "t": "mem", "base": {"t":"reg","v":"HL"} }` or `{ "t": "mem", "base": {"t":"sym","v":"global"} }`.
...
```jsonl
{"ir":"zasm-v1.1","k":"label","name":"print_hello"}
{"ir":"zasm-v1.1","k":"instr","m":"CALL","ops":[{"t":"sym","v":"print_hello"}]}
{"ir":"zasm-v1.1","k":"dir","d":"DB","name":"msg","args":[{"t":"str","v":"Hello"},{"t":"num","v":10}]}
{"ir":"zasm-v1.1","k":"instr","m":"LD","ops":[{"t":"sym","v":"A"},{"t":"mem","base":{"t":"reg","v":"HL"}}]}
```
