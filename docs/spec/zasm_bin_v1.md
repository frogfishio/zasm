...
# ZASM Binary Container (.zasm.bin) — v1 (Retired)

This document preserves the **retired** v1 `.zasm.bin` container format.

v1 was a proof-of-concept and is not intended for new integration work.
The current direction is a verifier-friendly, sectioned v2 format.
